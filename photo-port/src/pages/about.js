...
const AboutMe =()=>{
    return(
       <div className='container abt-me-box'>
           ...
           <p className="bio col-md-6">I am a UT student, formally from Phoenix, Arizona, studying full stack web developement.
       ...
       coding bootcamp which has made me acknowlege my ability to excel under immense amounts of pressure. </p>
       </div> 
       </div>
    )
}
